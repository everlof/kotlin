...
internal fun KtAnalysisSession.compareCalls(call1: KtCall, call2: KtCall): Int {
    ...
    return if (call1 is KtCallableMemberCall<*, *> && call2 is KtCallableMemberCall<*, *>) {
        stringRepresentation(call1.partiallyAppliedSymbol).compareTo(
            stringRepresentation(call2.partiallyAppliedSymbol)
        )
    } else 0
}