...
/**
 * A candidate that is applicable for a call. A candidate is applicable if the call's arguments are assignable to the candidate's parameters
 * and the call's type arguments fit all the constraints of the candidate's type parameters.
 */
...
/**
 * A candidate that is not applicable for a call. A candidate is applicable if the call's arguments are assignable to the candidate's
 * parameters and the call's type arguments fit all the constraints of the candidate's type parameters.
 */
