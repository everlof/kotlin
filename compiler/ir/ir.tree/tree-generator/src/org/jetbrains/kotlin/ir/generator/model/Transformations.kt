...
data class Model(val elements: List<Element>, val baseElement: Element)
...
fun config2model(config: Config): Model {
    ...
    val baseElement = replaceElementRefs(config, ec2el)
    ...
    return Model(elements, baseElement)
}
